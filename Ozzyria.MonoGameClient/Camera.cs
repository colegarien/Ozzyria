...
namespace Ozzyria.MonoGameClient
{
    internal class Camera
    {
        ...
        private void RecalculateInternals()
        {
            ...
            inversePosition = -(new Vector3((float)Math.Round(Position.X * 2, MidpointRounding.AwayFromZero) / 2f, (float)Math.Round(Position.Y * 2, MidpointRounding.AwayFromZero) / 2f, 0));
